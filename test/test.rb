...
# Tester.new('1505&1507 10TH AVE, SEATTLE, WA 98120')
# Tester.new('700-15355 Main Ave, Surrey BC V4A 2H9, Canada')
# Tester.new('15355 Main Ave,#700, Surrey BC V4A 2H9, Canada')
# Tester.new('700/15355 Main Ave, Surrey BC V4A 2H9, Canada')
# Tester.new('1600 Pennsylvania Ave N, New Minneapolis, MN 55555')
# Tester.new('1600A Pennsylvania Ave N, New Minneapolis, MN 55555')
# Tester.new('1600-A Pennsylvania Ave N, New Minneapolis, MN 55555')
# Tester.new('W204N11912 Goldendale Rd,AURORA,OR,97002')
# Tester.new('W204 N11912 Goldendale Rd,AURORA,OR,97002')
# Tester.new('15355 Main Ave #456, Surrey, MN, 55082')
# Tester.new('15355 Main Ave STE 456, Surrey, MN, 55082')
# Tester.new('9810 Medlock Bridge Rd Suite 500, Johns Creek, GA 30097, USA')
# Tester.new('9810 Medlock Bridge Rd #500, Johns Creek, GA 30097, USA')
Tester.new('15355 Main Ave STE G&H, Surrey, MN, 55082')
