...
class TestRegions < Minitest::Test
  ...
  def test_region_detection
    ...
    assert_equal NYAddressor::detect_region("123 Penn Ave, Washington, DC, United States"), :US
    assert_equal NYAddressor::detect_region("123 Penn Ave, Montreal, QC, H2Y 2R2"), :CA
    assert_equal NYAddressor::detect_region("123 Penn Ave, Montreal, QC, Canada"), :CA
    ...
    assert_equal NYAddressor::detect_region("21 Rue du Mesnil, 50400 Granville, FR"), :FR
    assert_equal NYAddressor::detect_region("92 Route de Marienthal, 67500 Haguenau, FR"), :FR
  end
